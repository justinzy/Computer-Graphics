...
imwrite(ColorPic1Map1,'colormapBlueIntensity.png','png');
...
Lp = hsv2rgb(Lp);
% imshow(Lp);
imwrite(Lp,'colormapBlueSaturation.png','png');
...
% imshow(rainbow);
imwrite(rainbow,'colormapBlueRainbow.png','png');
...
for i = 1:rows
    ...
    imwrite(blueRed,'colormapBlueBlueRed.png','png');
...
% imshow(twoColor);
imwrite(twoColor, 'colormapBlue2color.png', 'png');
...
heat = uint8(heat);
% imshow(heat);
imwrite(heat, 'colormapBlueHeat.png', 'png');
...
% imshow(colcon);
imwrite(colcon,'colormapBluecontour.png','png');
