...
imwrite(ColorPic1Map1,'colormapGreenIntensity.png','png');
...
Lp = hsv2rgb(Lp);
% imshow(Lp);
imwrite(Lp,'colormapGreenSaturation.png','png');
...
% imshow(rainbow);
imwrite(rainbow,'colormapGreenRainbow.png','png');
...
for i = 1:rows
    ...
    imwrite(blueRed,'colormapGreenBlueRed.png','png');
...
% imshow(twoColor);
imwrite(twoColor, 'colormapGreen2color.png', 'png');
...
heat = uint8(heat);
% imshow(heat);
imwrite(heat, 'colormapGreenHeat.png', 'png');
...
% imshow(colcon);
imwrite(colcon,'colormapGreencontour.png','png');
